...
int64 nChainStartTime = 1515675658;
...
const string strMessageMagic = "YunXunCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)                                                             
	{
        nSubsidy = 280000000 * COIN;
	}

	else if(nHeight > 1 && nHeight <= 90000000)
    {
        nSubsidy = 0 * COIN;
	}
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in YunXunCoin
    bool fStrictPayToScriptHash = true; // Always active in YunXunCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "YunXunCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector YunXunCoin empty mapBlockIndex YunXunCoin YunXunCoin";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xe84f8162d30e578114603303fa3e9bbdb0e7ee72908d33e8a9351e964d174bf7"));
